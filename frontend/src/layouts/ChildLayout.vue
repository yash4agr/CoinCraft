          ...
          <div class="relative profile-dropdown">
            ...
            >
              <div class="px-4 py-2 border-b border-gray-100">
                ...
                <div class="text-sm text-gray-500">Level {{ userStore.profile?.level }} Saver</div>
              </div>
              ...
              <button class="w-full flex items-center gap-3 px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">
                ...
                <router-link to="/child/profile" class="text-inherit no-underline">My Profile</router-link>
              </button>
...
const getAvatarUrl = () => {
  ...
  return `https://avataaars.io/?avatarStyle=Circle&topType=LongHairStraight2&accessoriesType=Blank&hairColor=BrownDark&facialHairType=Blank&clotheType=BlazerShirt&eyeType=Happy&eyebrowType=UpDownNatural&mouthType=Grimace&skinColor=Brown&seed=${encodedName}`
}
