...
from models import User, Class, ClassStudent, TeacherProfile, ChildProfile, UserModuleProgress
from schemas import ClassRead, ClassCreate, ClassUpdate, StudentRead
...
async def get_teacher_classes(
    ...
    # Get classes
    stmt = select(Class).where(Class.teacher_id == teacher_profile.id).order_by(Class.created_at.desc())
...
async def get_class_students(
    ...
    for student in students:
        ...
        # Get module progress
        progress_stmt = select(UserModuleProgress).where(UserModuleProgress.user_id == student.id)
        ...
        student_read = StudentRead(
            ...
            last_activity_date=student.child_profile.last_activity_date if student.child_profile else None,
